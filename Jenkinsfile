pipeline {
    ...
    stages {
        ...
        stage('Build Images') {
            steps {
                sh'''
                    docker build -t ${DOCKERHUB_USER}/auth-service:${IMAGE_TAG} auth-service
                    ...
                    docker build -t ${DOCKERHUB_USER}/api-gateway:${IMAGE_TAG} api-gateway
                    docker build -t ${DOCKERHUB_USER}/frontend-service:${IMAGE_TAG} frontend
                  '''
    }
